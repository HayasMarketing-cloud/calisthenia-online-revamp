...
const rawVideos: Omit<VideoMetadata, 'engagementScore' | 'durationSeconds'>[] = [
  ...
  { id: '7kPvnjZwN9Q', titulo: 'RUTINA DE ABDOMINALES con CALISTENIA EN CASA para PRINCIPIANTES', descripcion: 'Rutina de core o abdominales de 20 minutos para trabajar tu núcleo del cuerpo desde casa con ejercicios de calistenia fáciles. Incluye plancha abdominal, crunch, puente de glúteo, bird dog y plancha lateral.', duracion: 'PT10M4S', vistas: 54864, likes: 1761, comentarios: 21, zonaMuscular: 'Core', nivel: 'Principiante', material: 'Peso corporal' },
  { id: 'pwjUl5FQLCg', titulo: 'CÓMO EMPEZAR en CALISTENIA desde CASA y SIN MATERIAL', descripcion: 'Rutina completa en casa sin material que incluye flexiones, retracciones escapulares, dominadas en suelo, zancadas, plancha abdominal y crunches abdominales. Perfecta para principiantes.', duracion: 'PT13M27S', vistas: 24058, likes: 1071, comentarios: 30, zonaMuscular: 'Full Body', nivel: 'Principiante', material: 'Peso corporal' },
  { id: 'Eb63YMXWhH8', titulo: 'ELIMINA EL DOLOR DE ESPALDA CON UN CORE FUERTE', descripcion: 'Fortalece tu core para eliminar dolores de espalda y mejorar tu postura', duracion: 'PT48S', vistas: 7512, likes: 423, comentarios: 2, zonaMuscular: 'Core', nivel: 'Principiante', material: 'Peso corporal' },
  ...
  { id: 'JYJWPSQeYK4', titulo: 'ABDOMEN en CASA para un nivel intermedio', descripcion: 'Entrenamiento de abdomen específico para nivel intermedio que puedes hacer en casa.', duracion: 'PT27S', vistas: 4565, likes: 266, comentarios: 26, zonaMuscular: 'Core', nivel: 'Intermedio', material: 'Peso corporal' },
  { id: 'gZ9yDVkF0pk', titulo: '¿QUÉ ALIMENTOS PRIORIZAR para un FÍSICO FUERTE Y DEFINIDO?', descripcion: '¿Quieres marcar abdominales y verte más definido? La clave está en lo que comes. Alimentos que debes priorizar para bajar grasa sin perder músculo mientras entrenas calistenia.', duracion: 'PT11M17S', vistas: 2068, likes: 131, comentarios: 7, zonaMuscular: 'Core', nivel: 'Intermedio', material: 'Peso corporal' },
  ...
  { id: 'T7mcqT4xdC0', titulo: 'CORE Y ABDOMEN DE ACERO SIN MATERIAL en -10\'', descripcion: 'Entrenamiento CORE DE ACERO para proteger tu espalda baja, aguantar más en calistenia y mejorar estabilidad. Incluye plancha frontal a lateral, crunch abdominal, elevaciones de piernas, dead bug, mountain climbers, tap shoulders y giros rusos.', duracion: 'PT4M25S', vistas: 1393, likes: 111, comentarios: 4, zonaMuscular: 'Core', nivel: 'Avanzado', material: 'Peso corporal' },
  { id: 'TW7Yf6G-Tbk', titulo: '5 PASOS PARA HACER EL PINO desde 0', descripcion: 'Progresión completa para lograr el pino aunque seas principiante total', duracion: 'PT8M54S', vistas: 875, likes: 89, comentarios: 4, zonaMuscular: 'Hombros', nivel: 'Principiante', material: 'Peso corporal' },
  ...
  // === FULL BODY VIDEOS - Videos con "fullbody" o rutinas completas de cuerpo entero ===
  { id: 'IWqIZk3hF14', titulo: 'LA MEJOR RUTINA para EMPEZAR EN CALISTENIA | Rutina Fullbody Para Principiantes', descripcion: 'Rutina de cuerpo entero dedicada a principiantes que quieren saber cómo empezar a entrenar calistenia desde 0', duracion: 'PT9M49S', vistas: 36165, likes: 1313, comentarios: 31, zonaMuscular: 'Full Body', nivel: 'Principiante', material: 'Peso corporal' },
  { id: 'PmkNJ7fQhPY', titulo: 'RUTINA FULLBODY EN CASA de CALISTENIA', descripcion: 'Entrenamiento fullbody de calistenia que se puede realizar con una banda elástica y tu propio cuerpo', duracion: 'PT10M46S', vistas: 5409, likes: 223, comentarios: 13, zonaMuscular: 'Full Body', nivel: 'Avanzado', material: 'Bandas elásticas' },
  { id: 'i8ZvPj88vJs', titulo: 'HAZ ESTO si eres PRINCIPIANTE! | Rutina Fullbody empezando desde 0', descripcion: 'Rutina básica pero efectiva en la que trabajamos todos los grupos musculares para gente novata en calistenia', duracion: 'PT6M59S', vistas: 4173, likes: 278, comentarios: 51, zonaMuscular: 'Full Body', nivel: 'Principiante', material: 'Peso corporal' },
  { id: '-NUI2ed4oNA', titulo: 'INICIA EN CALISTENIA CON ESTA RUTINA fullbody para PRINCIPIANTES', descripcion: 'Rutina de iniciación en calistenia para principiantes. Mejora fuerza, movilidad y control corporal sin equipo', duracion: 'PT7M', vistas: 2408, likes: 180, comentarios: 10, zonaMuscular: 'Full Body', nivel: 'Principiante', material: 'Peso corporal' },
  { id: 'C03QUJkF2cI', titulo: '5 EJERCICIOS DE FUERZA EN CASA para PÉRDIDA DE GRASA CON BANDA ELÁSTICA', descripcion: '5 ejercicios de cuerpo entero con bandas elásticas para quemar grasa y activar todo tu cuerpo', duracion: 'PT7M46S', vistas: 485, likes: 49, comentarios: 0, zonaMuscular: 'Full Body', nivel: 'Intermedio', material: 'Bandas elásticas' },
  { id: 'bnzRXd4rtZA', titulo: 'LOS 3 BÁSICOS GRANDES OLVIDADOS DE LA CALISTENIA', descripcion: 'Aspectos que casi nadie trabaja pero que marcan la diferencia en fuerza, control y resultados', duracion: 'PT6M3S', vistas: 1198, likes: 115, comentarios: 10, zonaMuscular: 'Full Body', nivel: 'Intermedio', material: 'Peso corporal' }
];
