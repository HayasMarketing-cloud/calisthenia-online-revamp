    ...
    <div className="min-h-screen">
      ...
      <RoutineHero
        breadcrumbs={[
          ...
          { label: "Rutina Hombros", href: "/rutina-hombro" }
        ]}
        title="Rutina de"
        titleHighlight="Hombros"
        emoji="💪"
        description="Fortalece y desarrolla hombros potentes y estables con ejercicios de calistenia específicos para deltoides y manguito rotador."
      />
