...
import { BarChart3, Flame, Target, Activity, CalendarDays, Trophy, Award } from 'lucide-react';
...
const Progress = () => {
  ...
  // Notas del coach y feedback de técnica: retirados de esta vista (van por WhatsApp en la beta).
