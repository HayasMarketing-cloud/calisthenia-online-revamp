        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Bíceps</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Espalda</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Abdomen</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Piernas</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Pecho</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Full Body</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Sobre Nicolás</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Metodología</a></li>
